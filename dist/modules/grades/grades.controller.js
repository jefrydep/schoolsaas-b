...
let GradesController = class GradesController {
    ...
    getStudentCourseAverage(courseId, studentId) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], GradesController.prototype, "findByEvaluation", null);
__decorate([
...
__decorate([
    (0, common_1.Get)('average/:courseId/student/:studentId'),
    (0, roles_decorator_1.Roles)(role_enum_1.Role.SUPER_ADMIN, role_enum_1.Role.ADMIN, role_enum_1.Role.PROFESOR, role_enum_1.Role.ESTUDIANTE),
    ...
    __metadata("design:returntype", void 0)
], GradesController.prototype, "getStudentCourseAverage", null);
